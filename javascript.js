...
//move effect
scv1move = new Effect.Move(scvid, { x: movex, y: movey, mode: 'relative',duration:moveSpeed, transition: Effect.Transitions.linear,fps: 50,queue: { position: 'end', scope: 'scv1scope', limit:1} });
}
